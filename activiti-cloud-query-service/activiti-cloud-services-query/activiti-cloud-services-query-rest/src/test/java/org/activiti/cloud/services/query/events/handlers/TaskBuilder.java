...
public class TaskBuilder {
    ...
    public TaskBuilder withId(String taskId) {
        lenient().when(taskEntity.getId()).thenReturn(taskId);
        return this;
    }

    public TaskBuilder withName(String name) {
        lenient().when(taskEntity.getName()).thenReturn(name);
        return this;
    }

    public TaskBuilder withDescription(String description) {
        lenient().when(taskEntity.getDescription()).thenReturn(description);
        return this;
    }

    public TaskBuilder withPriority(Integer priority) {
        lenient().when(taskEntity.getPriority()).thenReturn(priority);
        return this;
    }
    ...
    public TaskBuilder withFormKey(String formKey) {
        lenient().when(taskEntity.getFormKey()).thenReturn(formKey);
        return this;
    }
    ...
    public TaskBuilder withAssignee(String assignee) {
        lenient().when(taskEntity.getAssignee()).thenReturn(assignee);
        return this;
    }
